...
const nowA = new Date();
const year1 = nowA.getFullYear(); 
const month1 = nowA.getMonth() + 1;
const date1 = nowA.getDate(); 
const hours1 = nowA.getHours(); 
const minutes1 = nowA.getMinutes(); 
console.log(`"fecha" ${year1}-${month1}-${date1}-  /${hours1}:${minutes1}`);

//DD-MM-AAAA HH:mm

const nowD = new Date();
const date2= nowD.getDate();
const month2 = nowD.getMonth() + 1;
const year2 = nowD.getFullYear();  
const hours2 = nowD.getHours(); 
const minutes2 = nowD.getMinutes(); 
console.log(`"fecha" ${date2}-${month2}-${year2}  /${hours2}:${minutes2}`);

//DD/MM/AAAA HH:mm

const nowH = new Date();
const date3 = nowH.getDate();
const month3 = nowH.getMonth() + 1;
const year3 = nowH.getFullYear();
const hours3 = nowH.getHours(); 
const minutes3 = nowH.getMinutes(); 
console.log(`Actual ${date3}/${month3}/${year3} ${hours3}:${minutes3}`); 
...
console.log(`fecha ${year}-${month}-${date}  ${Hours}:${minutes}`);
